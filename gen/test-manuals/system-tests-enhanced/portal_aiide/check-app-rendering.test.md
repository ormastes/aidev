# System Test Manual: check-app-rendering.test.ts
...
# Run with debugging
node --inspect-brk ./node_modules/.bin/jest check-app-rendering.test.ts
```

### Manual Execution
1. Open the test file: `/home/ormastes/dev/pub/aidev/layer/themes/portal_aiide/tests/system/check-app-rendering.test.ts`
