# System Test Manual: app-switching-workflow-e2e.systest.ts
...
### Suite: 🚨 Story: App Switching Workflow E2E System Test
...
# Run with debugging
node --inspect-brk ./node_modules/.bin/jest app-switching-workflow-e2e.systest.ts
```

### Manual Execution
1. Open the test file: `/home/ormastes/dev/pub/aidev/layer/themes/portal_aidev/user-stories/024-aidev-portal/tests/system/app-switching-workflow-e2e.systest.ts`
