# Test Manual: name-id-search.test.ts
...
- **File**: `name-id-search.test.ts`
- **Path**: `/home/ormastes/dev/pub/aidev/layer/themes/infra_filesystem-mcp/src/tests/name-id-search.test.ts`
- **Type**: Unit Test
- **BDD Format**: ❌ No
- **Async Tests**: ❌ No
- **Test Count**: 0
...
npm test -- name-id-search.test.ts

# Run with coverage
npm run test:coverage -- name-id-search.test.ts

# Run in watch mode
npm test -- --watch name-id-search.test.ts
```
...
*Quality Score: 0%*
*Generated at: 2025-08-28T01:16:20.224Z*
