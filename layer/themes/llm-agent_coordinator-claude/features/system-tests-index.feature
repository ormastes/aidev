Feature: System Tests Index - llm-agent_coordinator-claude
  As a test coordinator
  I want to track all system tests for llm-agent_coordinator-claude
  ...
  Scenario: Review available system tests
    Given the following system tests are available:
      | system-coordinator-comprehensive-system |
      | system-coordinator-e2e |
      | system-coordinator-integration-system |
      | system-coordinator-realtime-system |
