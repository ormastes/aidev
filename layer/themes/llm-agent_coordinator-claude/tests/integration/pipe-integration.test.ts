...
describe('coordinator-claude-agent pipe integration', () => {
  ...
  describe('theme isolation', () => {
    it('should not expose internal implementation details', () => {
      ...
      expect((pipe as any).ClaudeAPIClient).toBeUndefined();
      expect((pipe as any).ClaudeAuth).toBeUndefined();
      expect((pipe as any).Coordinator).toBeUndefined();
      expect((pipe as any).SessionManager).toBeUndefined();
      expect((pipe as any).PermissionManager).toBeUndefined();
    });
  });

  describe('coordinator-claude-agent theme integration', () => {
