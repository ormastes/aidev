Feature: Filesystem-mcp Infrastructure Manual Tests
  As an infrastructure engineer
  I want to manually test filesystem-mcp infrastructure
  So that I can ensure system reliability and performance

  @manual @deployment
  Scenario: Manual deployment verification
    Given the filesystem-mcp infrastructure is deployed
  ...
  Scenario: Manual monitoring and logging verification
    Given the filesystem-mcp monitoring is active
  ...
  Scenario: Manual disaster recovery testing
    Given the filesystem-mcp system is running
