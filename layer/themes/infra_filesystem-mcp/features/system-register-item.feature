Feature: System Test - register-item
  As a system tester
  I want to manually execute system tests for register-item
  ...
  @manual @system
  Scenario: System Test: register__type__item.js
    Given the system is in initial state
    When I execute the test steps for: System Test: register__type__item.js
    Then the expected outcome should be observed
    And no errors should occur

  @manual @system
  Scenario: should register a new item in NAME_ID.vf.json
    Given the system is in initial state
    When I execute the test steps for: should register a new item in NAME_ID.vf.json
    Then the expected outcome should be observed
    And no errors should occur

  @manual @system
  Scenario: should append to existing NAME_ID.vf.json
    Given the system is in initial state
    When I execute the test steps for: should append to existing NAME_ID.vf.json
    Then the expected outcome should be observed
    And no errors should occur

  @manual @system
  Scenario: should fail with insufficient arguments
    Given the system is in initial state
    When I execute the test steps for: should fail with insufficient arguments
    Then the expected outcome should be observed
    And no errors should occur
