Feature: Python-support Infrastructure Manual Tests
  As an infrastructure engineer
  I want to manually test python-support infrastructure
  So that I can ensure system reliability and performance

  @manual @deployment
  Scenario: Manual deployment verification
    Given the python-support infrastructure is deployed
  ...
  Scenario: Manual monitoring and logging verification
    Given the python-support monitoring is active
  ...
  Scenario: Manual disaster recovery testing
    Given the python-support system is running
