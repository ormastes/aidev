Feature: System Test - check-app-rendering
  As a system tester
  I want to manually execute system tests for check-app-rendering
  ...
  @manual @system
  Scenario: debug: check app rendering and console errors
    Given the system is in initial state
    When I execute the test steps for: debug: check app rendering and console errors
