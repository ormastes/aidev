Feature: System Test - test-failure-demo
  As a system tester
  I want to manually execute system tests for test-failure-demo
  ...
  @manual @system
  Scenario: Test Failure Verification
    Given the system is in initial state
    When I execute the test steps for: Test Failure Verification
    Then the expected outcome should be observed
    And no errors should occur

  @manual @system
  Scenario: should fail when expected element is missing
    Given the system is in initial state
    When I execute the test steps for: should fail when expected element is missing
    Then the expected outcome should be observed
    And no errors should occur
  ...
  Scenario: t match
    Given the system is in initial state
    When I execute the test steps for: t match
    Then the expected outcome should be observed
    And no errors should occur
