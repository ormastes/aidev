...
describe('coverage-aggregator pipe integration', () => {
  ...
  describe('theme isolation', () => {
    it('should not expose internal implementation details', () => {
      ...
      expect((pipe as any).CoverageAggregator).toBeUndefined();
      expect((pipe as any).CoverageReportGenerator).toBeUndefined();
      expect((pipe as any).IntegratedCoverageService).toBeUndefined();
      expect((pipe as any).SetupAggregatorAdapter).toBeUndefined();
    });
  });

  describe('coverage-aggregator theme integration', () => {
