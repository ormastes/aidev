Feature: Test-as-manual Infrastructure Manual Tests
  As an infrastructure engineer
  I want to manually test test-as-manual infrastructure
  So that I can ensure system reliability and performance

  @manual @deployment
  Scenario: Manual deployment verification
    Given the test-as-manual infrastructure is deployed
  ...
  Scenario: Manual monitoring and logging verification
    Given the test-as-manual monitoring is active
  ...
  Scenario: Manual disaster recovery testing
    Given the test-as-manual system is running
