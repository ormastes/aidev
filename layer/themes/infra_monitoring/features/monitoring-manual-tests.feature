Feature: Monitoring Infrastructure Manual Tests
  As an infrastructure engineer
  I want to manually test monitoring infrastructure
  So that I can ensure system reliability and performance

  @manual @deployment
  Scenario: Manual deployment verification
    Given the monitoring infrastructure is deployed
  ...
  Scenario: Manual monitoring and logging verification
    Given the monitoring monitoring is active
