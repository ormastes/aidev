Feature: External-log-lib Infrastructure Manual Tests
  As an infrastructure engineer
  I want to manually test external-log-lib infrastructure
  So that I can ensure system reliability and performance

  @manual @deployment
  Scenario: Manual deployment verification
    Given the external-log-lib infrastructure is deployed
  ...
  Scenario: Manual monitoring and logging verification
    Given the external-log-lib monitoring is active
  ...
  Scenario: Manual disaster recovery testing
    Given the external-log-lib system is running
