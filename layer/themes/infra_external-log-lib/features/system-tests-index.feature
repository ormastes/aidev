Feature: System Tests Index - infra_external-log-lib
  As a test coordinator
  I want to track all system tests for infra_external-log-lib
  ...
  Scenario: Review available system tests
    Given the following system tests are available:
      | system-centralized-log-service.stest |
      | system-complete-rotation-workflow.stest |
      | system-environment-validator |
      | system-global-setup |
      | system-global-teardown |
