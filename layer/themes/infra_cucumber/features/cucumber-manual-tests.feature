Feature: Cucumber Infrastructure Manual Tests
  As an infrastructure engineer
  I want to manually test cucumber infrastructure
  So that I can ensure system reliability and performance

  @manual @deployment
  Scenario: Manual deployment verification
    Given the cucumber infrastructure is deployed
  ...
  Scenario: Manual monitoring and logging verification
    Given the cucumber monitoring is active
  ...
  Scenario: Manual disaster recovery testing
    Given the cucumber system is running
