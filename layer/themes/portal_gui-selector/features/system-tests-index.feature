Feature: System Tests Index - portal_gui-selector
  As a test coordinator
  I want to track all system tests for portal_gui-selector
  ...
  Scenario: Review available system tests
    Given the following system tests are available:
      ...
      | system-gui-server-integration-real |
      | system-requirements-export-workflow |
