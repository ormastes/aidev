Feature: Fraud-checker Infrastructure Manual Tests
  As an infrastructure engineer
  I want to manually test fraud-checker infrastructure
  So that I can ensure system reliability and performance

  @manual @deployment
  Scenario: Manual deployment verification
    Given the fraud-checker infrastructure is deployed
  ...
  Scenario: Manual monitoring and logging verification
    Given the fraud-checker monitoring is active
  ...
  Scenario: Manual disaster recovery testing
    Given the fraud-checker system is running
