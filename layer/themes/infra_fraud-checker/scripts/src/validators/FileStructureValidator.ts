...
export class FileStructureValidator {
   ...
   */
  private async validateTemplate(dirPath: string, template: TemplateDefinition, context: string): Promise<void> {
    this.totalChecks++;
   ...
   */
  private async validateChild(parentPath: string, child: ChildDefinition, required: boolean, context: string): Promise<void> {
    this.totalChecks++;
   ...
   */
  private async checkFreezeViolations(dirPath: string, template: TemplateDefinition): Promise<void> {
   ...
   */
  private async checkUnexpectedFiles(dirPath: string, template: TemplateDefinition): Promise<void> {
   ...
   * Check pattern matching
   */
  private async checkPatterns(dirPath: string, patterns: string[]): Promise<void> {
    if (!fs.existsSync(dirPath)) return;
   ...
   */
  private addViolation(violation: ValidationViolation): void {
