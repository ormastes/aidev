...
`;
    ...
    await fileAPI.createFile(path.join(this.deployDir, 'EPIC.md'), { type: FileType.TEMPORARY }) {
...
`;
    ...
    await fileAPI.createFile(path.join(this.deployDir, 'BACKLOG.md'), { type: FileType.TEMPORARY }),
      velocityJson,
      { spaces: 2 }
    );
  }
