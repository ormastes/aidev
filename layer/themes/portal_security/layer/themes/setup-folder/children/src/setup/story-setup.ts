...
`;
    ...
    await fileAPI.createFile(path.join(this.deployDir, 'STORY.md'), { type: FileType.TEMPORARY }) {
...
`;
    ...
    await fileAPI.createFile(path.join(this.deployDir, 'tests', { type: FileType.TEMPORARY });
...
`;
    ...
    await fileAPI.createFile(path.join(this.deployDir, 'TASKS.md'), { type: FileType.TEMPORARY }), readme);
  }
