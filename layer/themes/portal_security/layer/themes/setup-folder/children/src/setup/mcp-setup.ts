...
export class MCPSetup {
   ...
   */
  private async log(message: string): void {
   ...
   * Log success message
   */
  private async logSuccess(message: string): void {
   ...
   * Log error message
   */
  private async logError(message: string): void {
   ...
   */
  private async getClaudeConfigDir(): string {
   ...
   */
  private async generateMCPConfig(aidevPath: string): any {
    return {
      mcpServers: {
        aidev: {
          command: 'node',
  ...
  private async installLocal(): Promise<void> {
    ...
    await fileAPI.createDirectory(localConfigDir);
  ...
  private async installUserWide(): Promise<void> {
    ...
    await fileAPI.createDirectory(claudeConfigDir);
   ...
   */
  async isDeployedEnvironment(): boolean {
