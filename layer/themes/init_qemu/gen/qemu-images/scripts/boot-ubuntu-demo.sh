...
echo "Mock QEMU Image: ubuntu-demo"
echo "Path: /home/ormastes/dev/aidev/layer/themes/init_qemu/gen/qemu-images/images/ubuntu-demo.qcow2"
echo ""
...
echo "  -m 2G \"
echo "  -cpu host \"
echo "  -drive file=/home/ormastes/dev/aidev/layer/themes/init_qemu/gen/qemu-images/images/ubuntu-demo.qcow2,if=virtio \"
