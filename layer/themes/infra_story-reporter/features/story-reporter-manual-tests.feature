Feature: Story-reporter Infrastructure Manual Tests
  As an infrastructure engineer
  I want to manually test story-reporter infrastructure
  So that I can ensure system reliability and performance

  @manual @deployment
  Scenario: Manual deployment verification
    Given the story-reporter infrastructure is deployed
  ...
  Scenario: Manual monitoring and logging verification
    Given the story-reporter monitoring is active
  ...
  Scenario: Manual disaster recovery testing
    Given the story-reporter system is running
