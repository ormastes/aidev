...
describe('env-config pipe integration', () => {
  ...
  describe('theme isolation', () => {
    it('should not expose internal implementation details', () => {
      ...
      expect((pipe as any).ConfigManager).toBeUndefined();
      expect((pipe as any).PortAllocator).toBeUndefined();
      expect((pipe as any).FileGenerator).toBeUndefined();
      expect((pipe as any).PortRegistry).toBeUndefined();
    });
  });

  describe('env-config theme integration', () => {
