Feature: lib_react-native-base Manual Tests
  As a tester
  I want to manually test lib_react-native-base functionality
  So that I can ensure system quality

  @manual @smoke
  Scenario: Manual smoke testing
    Given the lib_react-native-base system is deployed
