...
def main():
    ...
    print("Mock QEMU Image: dev-environment")
    print("Path: /home/ormastes/dev/aidev/layer/themes/init_qemu/gen/qemu-images/images/dev-environment.qcow2")
    print("")
    ...
    print("  -m 2G \")
    print("  -cpu host \")
    print("  -drive file=/home/ormastes/dev/aidev/layer/themes/init_qemu/gen/qemu-images/images/dev-environment.qcow2,if=virtio \")
