#!/usr/bin/env python3
"""
Migrated from: run-docker-test-basic.sh
Auto-generated Python - 2025-08-16T04:57:27.786Z
"""
...
def main():
    ...
    subprocess.run("CONTAINER_NAME="test-basic"", shell=True)
    ...
    subprocess.run("test-basic \", shell=True)
