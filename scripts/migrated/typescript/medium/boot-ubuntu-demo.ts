...
async function main() {
  ...
  console.log("Mock QEMU Image: ubuntu-demo");
  console.log("Path: /home/ormastes/dev/aidev/layer/themes/init_qemu/gen/qemu-images/images/ubuntu-demo.qcow2");
  console.log("");
  ...
  console.log("  -drive file=/home/ormastes/dev/aidev/layer/themes/init_qemu/gen/qemu-images/images/ubuntu-demo.qcow2,if=virtio \");
