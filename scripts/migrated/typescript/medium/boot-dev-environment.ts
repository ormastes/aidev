#!/usr/bin/env bun
/**
 * Migrated from: boot-dev-environment.sh
...
async function main() {
  ...
  console.log("Mock QEMU Image: dev-environment");
  console.log("Path: /home/ormastes/dev/aidev/layer/themes/init_qemu/gen/qemu-images/images/dev-environment.qcow2");
  console.log("");
  ...
  console.log("  -drive file=/home/ormastes/dev/aidev/layer/themes/init_qemu/gen/qemu-images/images/dev-environment.qcow2,if=virtio \");
